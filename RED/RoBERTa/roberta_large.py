...
from model import ActivationModelRoberta
...
parser.add_argument("--model_type", default="roberta_large")
parser.add_argument("--operation_key", default="ffn_all_layer")
...
meta_dir = f"{main_dir}/Results/RED/roberta_large/[Substitute_model_type]/[Substitute_meta]/[Substitute_dataset]/lr_{str(lr)}/weight_dacay_{str(weight_decay)}"
...
base_model = RobertaModel.from_pretrained("roberta-large", add_pooling_layer=False)
...
activation_model = ActivationModelRoberta(base_model, num_labels, op_position=op_position, layer_type=layer_type, exclude_layers=exclude_layers)
