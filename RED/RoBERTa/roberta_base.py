...
parser.add_argument("--dataset_name", default="mrpc")
...
meta_dir = f"{main_dir}/Results/RED/roberta_base/[Substitute_model_type]/[Substitute_meta]/[Substitute_dataset]/lr_{str(lr)}/weight_dacay_{str(weight_decay)}"
