...
from model import ActivationModelGPT2More
...
meta_dir = f"{main_dir}/Results/RED++/gpt2-large-more/[Substitute_meta]/[Substitute_dataset]/lr_{str(lr)}/weight_dacay_{str(weight_decay)}/seed_{str(seed)}/label_smooth_{str(label_smooth)}"
...
base_model = GPT2LMHeadModel.from_pretrained("gpt2-large")
activation_model = ActivationModelGPT2More(base_model)
