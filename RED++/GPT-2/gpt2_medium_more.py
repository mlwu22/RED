...
meta_dir = f"{main_dir}/Results/RED++/gpt2-medium-more/[Substitute_meta]/[Substitute_dataset]/lr_{str(lr)}/weight_dacay_{str(weight_decay)}/seed_{str(seed)}/label_smooth_{str(label_smooth)}"
